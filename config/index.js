export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxa4adf632b904e38f",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "1839f5d9ed309160e3fd858bf5d207a4",
  ...
  USERS: [
    {
      ...
      id: "o6BDX6JRj8qS2Sc59Hggm-d25glw",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "B_M_KwmOy-Ec5r3b6TxWR1ha2IXlkqNxJdpFj0bzDZI",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "南阳",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "生日倒数日", "year": "1998", "date": "11-15"},
      ...
      customizedDateList: [
        ...
        // 生日日
        {"keyword": "ex_day", date: "1998-11-15"},
      ]
    },
    {
      name: "老婆1",
  ...
  CALLBACK_TEMPLATE_ID: "B_M_KwmOy-Ec5r3b6TxWR1ha2IXlkqNxJdpFj0bzDZI",
